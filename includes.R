...
source('https://raw.githubusercontent.com/TheSupremeToast/frc-scouting-database-2023/main/api/eventmean.R')
source('https://raw.githubusercontent.com/TheSupremeToast/frc-scouting-database-2023/main/api/teamlist.R')
